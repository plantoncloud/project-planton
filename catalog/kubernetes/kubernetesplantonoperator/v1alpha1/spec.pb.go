...
type KubernetesPlantonOperatorSpec struct {
	...
	// *
	// The planton-operator chart version to install (e.g. "0.13.0"). The chart
	// and the operator image share one version line: chart 0.13.0 runs
	// operator v0.13.0. Defaults to the version this catalog release was
...
const file_catalog_kubernetes_kubernetesplantonoperator_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x14chart_version_format\x12Schart version must be an exact semver like \"0.13.0\" — ranges are not reproducible\x1a*this.matches('^[0-9]+\\\\.[0-9]+\\\\.[0-9]+$')\x8a\xa6\x1d\x060.13.0H\x00R\fchartVersion\x88\x01\x01\x12-\n" +
