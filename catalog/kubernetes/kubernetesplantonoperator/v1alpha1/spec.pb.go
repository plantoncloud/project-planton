...
const file_catalog_kubernetes_kubernetesplantonoperator_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x14chart_version_format\x12Schart version must be an exact semver like \"0.12.0\" — ranges are not reproducible\x1a*this.matches('^[0-9]+\\\\.[0-9]+\\\\.[0-9]+$')\x8a\xa6\x1d\x060.12.0H\x00R\fchartVersion\x88\x01\x01\x12-\n" +
